...
public final class DenyAppointmentClinicAdminSpecificFragmentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView idRVCourseDenyAppointmentClinicAdmin;

  @NonNull
  public final LinearLayoutCompat linearLayout;

  private DenyAppointmentClinicAdminSpecificFragmentBinding(@NonNull FrameLayout rootView,
      @NonNull ProgressBar categoryListProgressBar, @NonNull GifImageView clinicEmptyGif,
      @NonNull TextView clinicNotFoundText,
      @NonNull RecyclerView idRVCourseDenyAppointmentClinicAdmin,
    ...
    this.idRVCourseDenyAppointmentClinicAdmin = idRVCourseDenyAppointmentClinicAdmin;
  ...
  @NonNull
  public static DenyAppointmentClinicAdminSpecificFragmentBinding inflate(
  ...
  public static DenyAppointmentClinicAdminSpecificFragmentBinding inflate(
    ...
    View root = inflater.inflate(R.layout.deny_appointment_clinic_admin_specific_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DenyAppointmentClinicAdminSpecificFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.idRVCourseDenyAppointmentClinicAdmin;
      RecyclerView idRVCourseDenyAppointmentClinicAdmin = ViewBindings.findChildViewById(rootView, id);
      if (idRVCourseDenyAppointmentClinicAdmin == null) {
        break missingId;
      }
      ...
      return new DenyAppointmentClinicAdminSpecificFragmentBinding((FrameLayout) rootView,
          categoryListProgressBar, clinicEmptyGif, clinicNotFoundText,
          idRVCourseDenyAppointmentClinicAdmin, linearLayout);
    }
