...
public final class DenyAppointmentFragmentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView idRVCourseDenyAppointment;

  @NonNull
  public final LinearLayoutCompat linearLayout;

  private DenyAppointmentFragmentBinding(@NonNull FrameLayout rootView,
      @NonNull ProgressBar categoryListProgressBar, @NonNull GifImageView clinicEmptyGif,
      @NonNull TextView clinicNotFoundText, @NonNull RecyclerView idRVCourseDenyAppointment,
    ...
    this.idRVCourseDenyAppointment = idRVCourseDenyAppointment;
  ...
  @NonNull
  public static DenyAppointmentFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DenyAppointmentFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.deny_appointment_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DenyAppointmentFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.idRVCourseDenyAppointment;
      RecyclerView idRVCourseDenyAppointment = ViewBindings.findChildViewById(rootView, id);
      if (idRVCourseDenyAppointment == null) {
        break missingId;
      }
      ...
      return new DenyAppointmentFragmentBinding((FrameLayout) rootView, categoryListProgressBar,
          clinicEmptyGif, clinicNotFoundText, idRVCourseDenyAppointment, linearLayout);
    }
