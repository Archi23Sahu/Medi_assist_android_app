...
public final class AcceptAppointmentClinicAdminSpecificFragmentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView idRVCourseAcceptAppointmentClinicAdmin;

  @NonNull
  public final LinearLayoutCompat linearLayout;

  private AcceptAppointmentClinicAdminSpecificFragmentBinding(@NonNull FrameLayout rootView,
      @NonNull ProgressBar categoryListProgressBar, @NonNull GifImageView clinicEmptyGif,
      @NonNull TextView clinicNotFoundText,
      @NonNull RecyclerView idRVCourseAcceptAppointmentClinicAdmin,
    ...
    this.idRVCourseAcceptAppointmentClinicAdmin = idRVCourseAcceptAppointmentClinicAdmin;
  ...
  @NonNull
  public static AcceptAppointmentClinicAdminSpecificFragmentBinding inflate(
  ...
  public static AcceptAppointmentClinicAdminSpecificFragmentBinding inflate(
    ...
    View root = inflater.inflate(R.layout.accept_appointment_clinic_admin_specific_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AcceptAppointmentClinicAdminSpecificFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.idRVCourseAcceptAppointmentClinicAdmin;
      RecyclerView idRVCourseAcceptAppointmentClinicAdmin = ViewBindings.findChildViewById(rootView, id);
      if (idRVCourseAcceptAppointmentClinicAdmin == null) {
        break missingId;
      }
      ...
      return new AcceptAppointmentClinicAdminSpecificFragmentBinding((FrameLayout) rootView,
          categoryListProgressBar, clinicEmptyGif, clinicNotFoundText,
          idRVCourseAcceptAppointmentClinicAdmin, linearLayout);
    }
