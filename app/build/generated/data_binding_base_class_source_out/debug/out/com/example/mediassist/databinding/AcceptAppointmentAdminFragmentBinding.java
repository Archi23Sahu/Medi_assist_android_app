...
public final class AcceptAppointmentAdminFragmentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView idRVCourseAcceptAppointmentAdmin;

  @NonNull
  public final LinearLayoutCompat linearLayout;

  private AcceptAppointmentAdminFragmentBinding(@NonNull FrameLayout rootView,
      @NonNull ProgressBar categoryListProgressBar, @NonNull GifImageView clinicEmptyGif,
      @NonNull TextView clinicNotFoundText, @NonNull RecyclerView idRVCourseAcceptAppointmentAdmin,
    ...
    this.idRVCourseAcceptAppointmentAdmin = idRVCourseAcceptAppointmentAdmin;
  ...
  @NonNull
  public static AcceptAppointmentAdminFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AcceptAppointmentAdminFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.accept_appointment_admin_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AcceptAppointmentAdminFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.idRVCourseAcceptAppointmentAdmin;
      RecyclerView idRVCourseAcceptAppointmentAdmin = ViewBindings.findChildViewById(rootView, id);
      if (idRVCourseAcceptAppointmentAdmin == null) {
        break missingId;
      }
      ...
      return new AcceptAppointmentAdminFragmentBinding((FrameLayout) rootView,
          categoryListProgressBar, clinicEmptyGif, clinicNotFoundText,
          idRVCourseAcceptAppointmentAdmin, linearLayout);
    }
