...
public final class ActivityClinicBinding implements ViewBinding {
  ...
  private ActivityClinicBinding(@NonNull CoordinatorLayout rootView, @NonNull MaterialButton btnAdd,
  ...
  public static ActivityClinicBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityClinicBinding((CoordinatorLayout) rootView, btnAdd, btnBack, textTitle);
    }
