...
public final class ActivityForgotPasswordBinding implements ViewBinding {
  ...
  private ActivityForgotPasswordBinding(@NonNull CoordinatorLayout rootView,
      @NonNull MaterialButton btnBack, @NonNull TextView pwdTitle) {
  ...
  public static ActivityForgotPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.pwdTitle;
      TextView pwdTitle = ViewBindings.findChildViewById(rootView, id);
      if (pwdTitle == null) {
        break missingId;
      }

      return new ActivityForgotPasswordBinding((CoordinatorLayout) rootView, btnBack, pwdTitle);
    }
